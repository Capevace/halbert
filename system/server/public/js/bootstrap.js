        ...
        T = (function() {
          ...
          return h.prototype.next = function() {
            ...
            e || (this._isPaused = !0), t(this._element).find(v.NEXT_PREV)[0] &&
              ...
              (r.triggerTransitionEnd(this._element), this.cycle(
                !0
            ...
            t || (this._isPaused = !1), this._interval &&
              (clearInterval(
                this._interval
              ), this._interval = null), this._config.interval &&
              !this._isPaused &&
            ...
            if (
              (e === p.NEXT
                ...
                : (l = E.RIGHT, h = E.PREV, c = p.RIGHT), s &&
                t(s).hasClass(E.ACTIVE))
            )
            ...
            if (!d.isDefaultPrevented() && o && s) {
              ...
              r.supportsTransitionEnd() && t(this._element).hasClass(E.SLIDE)
                ? (t(s).addClass(h), r.reflow(s), t(o).addClass(l), t(
                    s
                  ).addClass(l), t(o)
                ...
                : (t(o).removeClass(E.ACTIVE), t(s).addClass(
                    E.ACTIVE
                  ), this._isSliding = !1, t(this._element).trigger(f)), a &&
                this.cycle();
            }
        ...
        E = (function() {
          ...
          return l.prototype.toggle = function() {
            ...
            var e = this,
              ...
              i = '[data-toggle="collapse"][data-parent="' +
                this._config.parent +
                '"]';
        ...
        v = (function() {
          function h(e, i) {
            n(this, h), this._config = this._getConfig(
              i
            ), this._element = e, this._dialog = t(e).find(E.DIALOG)[
              0
            ], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0;
          }
          return h.prototype.toggle = function(t) {
            ...
            t(this._element).trigger(i), this._isShown ||
              ...
              (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), t(
                document.body
              ).addClass(
                m.OPEN
              ), this._setEscapeEvent(), this._setResizeEvent(), t(
                this._element
            ...
            t(this._element).trigger(o), this._isShown &&
              ...
              (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), t(
                document
              ).off(p.FOCUSIN), t(this._element).removeClass(m.SHOW), t(
                this._element
              ).off(p.CLICK_DISMISS), t(this._dialog).off(
                p.MOUSEDOWN_DISMISS
              ), i
                ? t(this._element)
                    .one(r.TRANSITION_END, function(t) {
        ...
        m = (function() {
          ...
          return h.prototype.refresh = function() {
            ...
            for (var o = this._offsets.length; o--; ) {
              var r = this._activeTarget !== this._targets[o] &&
                t >= this._offsets[o] &&
        ...
        _ = (function() {
          ...
          return e.prototype.show = function() {
            ...
            if (
              ...
              if (
                (i && t(i).trigger(a), t(this._element).trigger(
                  l
        ...
        I = (function() {
          ...
          return h.prototype.enable = function() {
            ...
            t(this.element).trigger(o), o.isDefaultPrevented() ||
              (t(i).removeClass(m.SHOW), this._activeTrigger[
                T.CLICK
              ] = !1, this._activeTrigger[T.FOCUS] = !1, this._activeTrigger[
                T.HOVER
              ] = !1, r.supportsTransitionEnd() && t(this.tip).hasClass(m.FADE)
            ...
            return n = n || t(e.currentTarget).data(i), n ||
              ...
              : (clearTimeout(
                  n._timeout
                ), n._hoverState = g.SHOW, n.config.delay && n.config.delay.show
            ...
            if (
              ...
              return clearTimeout(
                n._timeout
              ), n._hoverState = g.OUT, n.config.delay && n.config.delay.hide
                ? void (n._timeout = setTimeout(
                    function() {

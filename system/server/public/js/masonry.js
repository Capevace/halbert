...
!(function(t, e) {
  ...
  return e.on = function(t, e) {
    ...
    if (i && i.length) {
      ...
      for (var r = this._onceEvents && this._onceEvents[t]; o; ) {
        var s = r && r[o];
        s && (this.off(t, o), delete r[o]), o.apply(this, e), n += s
          ? 0
          : 1, o = i[n];
      }
      return this;
  ...
  function r(e) {
    if (
      ...
      var x = t(r.height);
      return x !== !1 &&
        (a.height = x + (z ? 0 : g + E)), a.innerWidth = a.width -
        (p + _), a.innerHeight = a.height - (g + E), a.outerWidth = a.width +
        y, a.outerHeight = a.height + v, a;
    }
  }
  var s,
  ...
  n.extend(f, e.prototype), f.option = function(t) {
    ...
    return i.defaults = n.extend({}, r.defaults), n.extend(
      ...
      {},
      r.compatOptions
    ), i.namespace = t, i.data = r.data, i.Item = s(o), n.htmlInit(i, t), u &&
      u.bridget &&
      u.bridget(t, i), i;
  };
  var m = { ms: 1, s: 1e3 };
